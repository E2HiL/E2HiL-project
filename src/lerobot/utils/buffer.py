...
class ReplayBuffer:
    ...
    def _initialize_storage(
        ...
        self.tags = torch.empty((self.capacity,), dtype=torch.long, device=self.storage_device) # cpu
    ...
    def from_lerobot_dataset(
        ...
        # Fill the buffer with all transitions cpu
        for data in list_transition:
            ...
            replay_buffer.add(
                ...
                # Samples created from LeRobotDataset are tagged as 1
