...
class SACPolicy(
    ...
    def select_action(self, batch: dict[str, Tensor]) -> Tensor:
        ...
        print("generate discrete_action:", discrete_action)
        return actions
    ...
    def forward(
        ...
        if model == "temperature":
            ...
            return {
                ...
                "policy_entropy": policy_entropy.item(),     # float for logging
                "target_entropy": float(self.target_entropy) # optional: returned for comparison
            }
    ...
    def compute_loss_temperature(self, observations, observation_features: Tensor | None = None) -> Tensor:
        ...
        policy_entropy = (-log_probs).mean().detach() 
        # breakpoint()
...
class CriticEnsemble(nn.Module):
    ...
    def forward(
        ...
        print(">> raw actions in critic:", actions.shape)
        ...
        # Stack outputs to match expected shape [num_critics, batch]
